<template>
    <div class="main-container py-8 " id="portfolio">
        <div class="flex justify-between mb-8">
            <h1 class="text-4xl font-bold mb-4 leading-snug mb-6">My portfolio</h1>
            <button class="bg-rose-600  rounded-xl h-fit p-2 text-white flex items-center gap-2">
        ...
        <div class="flex justify-between">
            <PortfolioCard v-for="( project, index) in Projects" :key="index" :index="index" :project="project"
    ...
    <div class="py-8 bg-sky-100  ">
        <h1 class="text-4xl font-bold mb-4 leading-snug mb-6">Customer testimonials</h1>
